        ...
        {recipes.map((recipe, i) => (
          <div className="recipe" key={recipe.id}>
            ...
            <div className="buttons">
              <button className="button-view" onClick={() => handleView(recipe.id)}>
          ...
          <div className="popup-inner">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <button type="button" className="button-view" onClick={handleIngredientCount}>
                  Add igredient
                </button>
              </div>
              <div className="form-group">
                ...
                <button type="button" className="button-view" onClick={handleStepCount}>
                  Add step
                </button>
              </div>
              <div className="buttons">
